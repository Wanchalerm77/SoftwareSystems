...
/**
 * Testprogram for Room and Guest. Lab Exercise SoftwareSystems
 * 
...
public class GuestTest {
	 ...
	 * <p>
	 * Assigns a <tt>Guest</tt> object to the <tt>ot</tt> instance variable with
	 * the name <tt>&quot;Ot&quot;</tt> and assigns a <tt>Guest</tt> object to
	 * the <tt>sien</tt> instance variable with the name
	 * <tt>&quot;Sien&quot;</tt>. Also assigns <tt>Room</tt> objects to instance
	 * variables <tt>k101</tt> and <tt>k102</tt> with numbers <tt>101</tt> and
	 * <tt>102</tt> respectively. Lastly, checks in <tt>sien</tt> in room
	 * <tt>k102</tt>.
	 */
	@Before
	public void setUp() {
	...
	/**
	 * Tests checking in a new guest in an empty room. Calls
	 * <tt>ot.checkin(k101)</tt>.
	 */
	@Test
	...
	/**
	 * Checks checking in a new guest in a room that is already taken. Calls
	 * <tt>ot.checkin(k102)</tt>.
	 */
	@Test
	...
	/**
	 * Tests checking out a guest that rented a room. Calls
	 * <tt>sien.checkout()</tt>.
	 */
	@Test
	...
	/**
	 * Tests checking out a guest that didn't rent a room. Calls
	 * <tt>ot.checkout()</tt>.
	 */
	@Test
