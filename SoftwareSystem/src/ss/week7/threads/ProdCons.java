...
/**
 * Main class for Producer/Consumer program illustrating multiple threads
 * modifying a shared object. Illustrates the need for synchronisation and the
 * use of wait and notify This program is based on code provided by Deitel and
 * Deitel <br>
