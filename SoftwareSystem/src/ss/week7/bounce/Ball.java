...
public class Ball {
	...
	/**
	 * Collision of two balls has the effect that both balls 'turn around' 180
	 * degrees. Could be better
	 */
	...
	/**
	 * Point is handy because we have a method for euclidian distance (see
